...
== Aufgabe 1: AI Kurs-Assistent erweitern (⭐⭐⭐)
...
==== 1.2 Wissensbasis erweitern (45 Minuten)
...
== Aufgabe 2: LangChain Grundlagen verstehen (⭐⭐)

=== Lernziel
Verstehen Sie die Konzepte von LangChain, bevor wir sie praktisch anwenden.

=== 2.1 Dokumentation lesen (60 Minuten)
...
=== 2.2 Konzept-Map erstellen (30 Minuten)
...
=== 2.3 Vergleich erstellen (30 Minuten)
...
== Aufgabe 3: RAG (Retrieval Augmented Generation) verstehen (⭐⭐⭐)

=== Lernziel
Verstehen Sie das RAG-Konzept und seine Anwendung in AI-Systemen.

=== 3.1 RAG-Theorie (45 Minuten)
...
=== 3.2 RAG-Diagramm zeichnen (30 Minuten)
...
=== 3.3 RAG-Anwendungsfall entwerfen (45 Minuten)
...
=== 4.2 Similarity-Experiment (45 Minuten)
...
=== 4.3 Vektordatenbank-Vergleich (30 Minuten)
...
=== 5.2 Mini-RAG Prototyp (90 Minuten)
